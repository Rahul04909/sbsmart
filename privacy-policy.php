                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            <h1 class="display-6 fw-bold text-dark">Privacy Policy</h1>
                        ...
                        <div class="policy-content">
                            ...
                            <h4 class="fw-bold mt-4 mb-3">2. How We Use Your Data</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">3. Data Sharing & Disclosure</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">4. Security Measures</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">5. Cookies</h4>
