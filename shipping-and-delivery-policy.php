                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            <h1 class="display-6 fw-bold text-dark">Shipping & Delivery Policy</h1>
                            <p class="text-muted">Last updated: November 22, 2025</p>
                        </div>
                        ...
                        <div class="policy-content">
                            ...
                            <h4 class="fw-bold mt-4 mb-3">1. Shipping Locations</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">2. Shipping Methods & Charges</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">3. Delivery Timelines</h4>
                            ...
                            <p class="small text-muted">Note: Business days exclude Sundays and public holidays.</p>

                            <h4 class="fw-bold mt-4 mb-3">4. Order Processing</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">5. Tracking Your Order</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">6. Delivery Issues</h4>
                            ...
                            <div class="alert alert-light border mt-3">
                                ...
                                Email: <a href="mailto:marcom.sbsyscon@gmail.com">marcom.sbsyscon@gmail.com</a> <br>
                                Phone: <a href="tel:+911294150555">(+91) 129 4150 555</a>
                            </div>

                            <h4 class="fw-bold mt-4 mb-3">7. Failed Deliveries</h4>
...
<style>
    .policy-content p { color: #555; line-height: 1.7; }
    .policy-content li { color: #555; margin-bottom: 0.5rem; }
    .policy-content h4 { color: #333; margin-top: 2rem; }
</style>
