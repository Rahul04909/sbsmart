                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            <h1 class="display-6 fw-bold text-dark">Terms & Conditions</h1>
                        ...
                        <div class="policy-content">
                            ...
                            <h4 class="fw-bold mt-4 mb-3">2. Product Information & Pricing</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">3. Orders & Payments</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">4. Intellectual Property</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">5. Limitation of Liability</h4>
                            ...
                            <h4 class="fw-bold mt-4 mb-3">7. Changes to Terms</h4>
